...
export const tickets: Ticket[] = [
    ...
    { id: 'TKT-012', status: 'New', channel: 'Email', createdAt: '2024-07-28T14:00:00Z', updatedAt: '2024-07-28T14:00:00Z', customerId: 'CUST-007', vehicle: { make: 'Toyota', model: 'Yaris', year: 2022, plate: 'GH22 IJK' }, parts: ['rear light cluster'], assignedToUserId: 'USER-001', priority: 'Low', slaDueAt: '2024-07-30T14:00:00Z', lastMessagePreview: 'Hi, following up on my other request, do you also have a rear light cluster?' },
];
...
export const messages: Message[] = [
    ...
    { id: 'MSG-003', ticketId: 'TKT-002', direction: 'outbound', channel: 'SMS', body: 'Hi Bob, we have those in stock. The bumper is £150 and the headlight is £90. We can have them ready for collection tomorrow.', media: [], createdAt: '2024-07-28T11:35:00Z', senderName: 'John Doe' },
    ...
    { id: 'MSG-005', ticketId: 'TKT-003', direction: 'outbound', channel: 'WhatsApp', body: 'Hi Charlie, thanks for the picture. Can you send a picture of the connector on the radiator please? Just want to make sure we get you the right one.', media: [], createdAt: '2024-07-27T16:00:00Z', senderName: 'Jane Smith' },
];
